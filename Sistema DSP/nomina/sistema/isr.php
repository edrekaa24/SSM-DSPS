...
$sql = "SELECT
    SUM(IIF(A.CONCEPTO='01' AND A.TIPO=2,IMPORTE,0)) as IMPORTE,
    B.UNIDAD,
    C.PRESUP,
    C.CUENTA
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>CEDULA DE PRESUPUESTOS PARA EL PAGO DEL ISR - QUINCENAL</h1>
            </div>
        </div><!--pageheader-->
            ...
            if( !mssql_num_rows($stmt)) {
                ...
                ?>
                     ...
                     ?> 
                        ...
                        <button onclick="exportTableToCSV('CEDULA_DE_PRESUPUESTOS_PARA_EL_PAGO_DEL_ISR-QUINCENA-<?php echo $qna; ?>.csv')" class="btn btn-primary">Descargar</button>
                        <?php
                    }
                 ?>
