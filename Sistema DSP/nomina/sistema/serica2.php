...
$a=10;
$b=5;
echo "<center>************Development************</center>";
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="maincontentinner">
                ...
                <form  name="form1" method="get" action="arch_serica2.php" >
                <h4>Tipo:</h4>
                <select id="tipo" name="tipo">
                    <option value="O">ORDINARIA</option>
                    <option value="ER">EXTRARDINARIA y RETROACTIVO</option>
                    <option value="D">DIFERENCIAS</option>                  
                </select>
                ...
                <select id="ref" name="ref">
                    ...
                    <option value="PRO">PROSPERA</option>
                </select>
