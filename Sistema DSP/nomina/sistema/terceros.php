                   ...
                   <div class="row-fluid">
                                <div class="span4">     
                                    <ul class="nav nav-tabs nav-stacked samplenavs">
                                        <li><a href="isr.php"> &nbsp;CEDULA DE PRESUPUESTOS PARA EL PAGO DEL ISR QUINCENAL</a></li>
                                        <li><a href="#"> &nbsp;CEDULA ISSSTE PAGOS DE CUOTAS Y APORTACIONES</a></li>
                                        <li><a href="viv.php"> &nbsp;CEDULA ISSSTE COMISIÓN EJECUTIVA DEL FONDO DE LA VIVIENDA AMORTIZACIÓN Y SEGURO DE DAÑOS</a></li>
                                        <li><a href="terinst.php"> &nbsp;SOLICITUD PARA PAGO A TERCEROS INSTITUCIONALES</a></li>
                                        <li><a href="serica.php"> &nbsp;SERICA</a></li>
                                    </ul>
                                </div>
                    </div>
            </div>
