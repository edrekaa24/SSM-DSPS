...
$sql = "SELECT
    SUM(IIF(A.CONCEPTO='64' AND A.TIPO=2,IMPORTE,0)) as AMORTIZACION,
    SUM(IIF(A.CONCEPTO='56' AND A.TIPO=2,IMPORTE,0)) as CREHIPOTECARIO,
    SUM(IIF(A.CONCEPTO='65' AND A.TIPO=2,IMPORTE,0)) as SEGURO,
    B.UNIDAD,
    C.PRESUP,
    C.CUENTA
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>CEDULA ISSSTE COMISIÓN EJECUTIVA DEL FONDO DE LA VIVIENDA AMORTIZACIÓN Y SEGURO DE DAÑOS - QUINCENAL</h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
            ...
            if( !mssql_num_rows($stmt)) {
                        echo '<h4></h4>';
                             ...
                             ?>    
                                        ...
                                        <TR> 
                                            ...
                                            <TH align="center">CRÉDITO HIPOTECARIO</TH>
                                            <TH align="center">SEGURO DE DAÑOS</TH>
                                        </TR>
                            <?php
                ...
                ?>
                            ...
                            <td><?php echo number_format($amort, 2, '.', '');?></td>
                            <td><?php echo number_format($hip, 2, '.', '');?></td>
                            <td><?php echo number_format($seg, 2, '.', '');?></td>
                            </TR>          
                     <?php
                     ...
                     ?>        
                        ...
                        <button onclick="exportTableToCSV('CEDULA_ISSSTE_COMISION_EJECUTIVA_DEL_FONDO_DE_LA_VIVIENDA_AMORTIZACION_Y_SEGURO_DE_DAÑOS_QNA-<?php echo $qna; ?>.csv')"class="btn btn-primary">Descargar</button>
                        <?php
                    }
                 ?>
