            ...
            <div class="maincontentinner">
                <div class="row-fluid">
                    <div id="dashboard-left" class="span8">
                        <h5 class="subtitle">ALTA, BAJA O MODIFICACIÓN</h5>
                        <ul class="shortcuts">
                            <li class="events">
                                <a href="fump2.php">
                                    <span class="shortcuts-icon iconsi-plus"></span>
                                    <span class="shortcuts-label">Nuevo Empleado</span>
                                </a>
                            </li>
                            <li class="products">
                                <a href="fump-search.php">
                                   <span class="shortcuts-icon iconsi-edit"></span>
                                    <span class="shortcuts-label">Existente</span>
                                </a>
                            </li>
