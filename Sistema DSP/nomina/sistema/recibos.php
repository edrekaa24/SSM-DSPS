    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
             ...
             <div class="maincontentinner">
                ...
                <form  name="form1" method="post" action="recibos2.php" class="searchbar">
                <input name="search" type="text"  placeholder="Ingrese un rfc y despues presione enter..." size="80" maxlength="80" style="
                height: 38px; width: 522px;" />
                <input type="submit" name="Submit" value="Buscar" style="width:90px; position: relative;left: 570px;" />
                </form>
            </div>
        </div>
