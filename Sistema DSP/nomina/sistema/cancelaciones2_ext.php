...
$sql = "SELECT TOTXPER.*, Nomina.nomina FROM TOTXPER,Nomina WHERE EMPLEADO LIKE '".$rfc."' and nomina.siglas=TOTXPER.ref_nom ORDER BY ANO DESC , QUINCENA DESC";
            ...
            <div class="maincontentinner">
                ...
                ?>
                            ...
                            ?>
                             ...
                             <td> <a href="cancelaciones3.php?id_totxper=<?php echo $id_totxper;?>&stado=<?php echo $stado;?>&rfc=<?php echo $rfc;?>"> <img src="images/edit.png" style="width:20px;height:20px;border:0;"></a></td>
                             <?php
                             }
                              if($stado=='NP  '){
                            ?>
                             ...
                             <?php
                              ...
                              ?>
                             <td><img src="images/edit.png" style="width:20px;height:20px;border:0;"></a></td>
                             <?php
                             }
                             ?>
                            </TR>  
