...
$sql = "SELECT a.QUINCENA,a.PERCEPCIONES,a.DEDUCCIONES,a.fecha_pago,a.archivo_pdf,B.ARCHIVO_XML FROM TOTXPER A inner JOIN TIMBRES B 
...
WHERE A.STADO!='C' AND a.EMPLEADO = '".$rfc."'";//a.ano=2018
        ...
        <div class="maincontent">
            ...
            <div class="maincontentinner">
                ...
                ?>
                            ...
                            <td><?php echo $row['fecha_pago']->format('Y-m-d');?></td>
                            <td><?php echo $percepciones;?></td>
                            <td><?php echo $deducciones;?></td>
                            <td><?php echo $total;?></td>
                            <td> <a href="<?php echo $pdf;?>"> <img src="images/pdf.png" style="width:42px;height:42px;border:0;"></a> <a href="<?php echo $xml;?>"> <img src="images/xml.png" style="width:42px;height:42px;border:0;"></a></td>
                            </TR>  
                            <?php
                            }
                            }
