                ...
                <div class="row-fluid">
                    <div id="dashboard-left" class="span8">
                        ...
                        <table id="t01">
                            ...
                            <tr>
                                <!--Anuncio-->
                                <td><b>A partir del 16 de Enero de 2019 ya se encuentran disponibles los archivos de productos y reportes quincenales de nómina correspondientes a la quincena 1-2019</b></td>
                                <!--Pubicado por-->
                            ...
                            <tr>
                                <!--Anuncio-->
                                <td>A partir del 26 de Abril de 2018 se podrán consultar los reportes de nómina en formato XLS, PDF y BDF.</td>
                                <!--Pubicado por-->
                                <td>Administrador del Sistema.</td>  
                                <!--Fecha de publicación-->    
                                <td>26-Abril-2018 / 13:00 HRS</td>
                            </tr>
                            <tr>
                                <!--Anuncio-->
