    ...
    <div class="loginpanelinner">
        ...
        <form name="f1" action="register.php" method="post">
            ...
            <div class="inputwrapper animate1 bounceIn">
                <input type="text" name="rfc" id="rfc" placeholder="RFC" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="13" required/>
            </div>
            ...
            <div class="inputwrapper animate2 bounceIn">
                <input type="text" name="uuid" id="uuid" placeholder="FOLIO FISCAL DIGITAL" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="12" required/>
            </div>
            
            <div class="inputwrapper animate3 bounceIn">
                <button name="submit" onClick="comprobarClave()">REGISTRARSE</button>
            </div>

            <div class="inputwrapper animate4 bounceIn">
                <a href="index.php"><label>INGRESAR</label></a>
            </div>
